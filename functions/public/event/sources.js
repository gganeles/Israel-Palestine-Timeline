...
//
//   const sources = Convert.toSources(json);
//
...
function toSources(json) {
    return cast(JSON.parse(json), r("Sources"));
}

function sourcesToJson(value) {
    return JSON.stringify(uncast(value, r("Sources")), null, 2);
}
...
const typeMap = {
    ...
    "Source": o([
        ...
        { json: "specialIcon", js: "specialIcon", typ: null },
    ...
    "BiasRating": o([
        ...
        { json: "politicalBias", js: "politicalBias", typ: r("BiasEnum") },
